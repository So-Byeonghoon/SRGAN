...
def _train():
    ...
    # Setup async input queues
    train_features, train_labels = GAN_input.setup_inputs(sess, train_filenames)
    test_features,  test_labels  = GAN_input.setup_inputs(sess, test_filenames)
    ...
    GAN_train.train_model(train_data)
